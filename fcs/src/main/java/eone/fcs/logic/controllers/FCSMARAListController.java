...
public class FCSMARAListController
    extends FCSMARAListController_GENERATED
    implements ICCEEConstants
{
    public FCSMARAListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
