...
public class FCSLFA1ListController
    extends FCSLFA1ListController_GENERATED
    implements ICCEEConstants
{
    public FCSLFA1ListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
