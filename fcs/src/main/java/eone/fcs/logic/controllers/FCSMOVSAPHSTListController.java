...
public class FCSMOVSAPHSTListController
    extends FCSMOVSAPHSTListController_GENERATED
    implements ICCEEConstants
{
    public FCSMOVSAPHSTListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
