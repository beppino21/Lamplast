...
public class UMFORListController
    extends UMFORListController_GENERATED
    implements ICCEEConstants
{
    public UMFORListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
