...
public class FCSRESTLOGListController
    extends FCSRESTLOGListController_GENERATED
    implements ICCEEConstants
{
    public FCSRESTLOGListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
