...
public class FCSEKETHSTListController
    extends FCSEKETHSTListController_GENERATED
    implements ICCEEConstants
{
    public FCSEKETHSTListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
