...
public class FCSSYNCListController
    extends FCSSYNCListController_GENERATED
    implements ICCEEConstants
{
    public FCSSYNCListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
