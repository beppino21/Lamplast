...
public class FCSEKETListController
    extends FCSEKETListController_GENERATED
    implements ICCEEConstants
{
    public FCSEKETListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
