...
public class FCSMOVSAPListController
    extends FCSMOVSAPListController_GENERATED
    implements ICCEEConstants
{
    public FCSMOVSAPListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
