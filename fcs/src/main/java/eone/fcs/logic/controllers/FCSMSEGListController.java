...
public class FCSMSEGListController
    extends FCSMSEGListController_GENERATED
    implements ICCEEConstants
{
    public FCSMSEGListController(ENUMEditMode editMode, DCDataContext<?> dataContext, String embeddedId)
    {
