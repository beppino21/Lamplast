...
public class FCSEKETBeanGrid_PREV implements IPreviewInstanceConfigurator<FCSEKETBeanGrid>
{
    @Override
    public void configureForPreview(String beanName, FCSEKETBeanGrid instance)
    {
        DCDataContextDummy dc = new DCDataContextDummy(new Object());
        instance.prepare(ENUMEditMode.EDIT,dc,DOFCSEKET.class,"dummy",null);
    }
}
