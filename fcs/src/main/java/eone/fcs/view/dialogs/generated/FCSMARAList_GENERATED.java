...
@CCGenClass (expressionBase="#{d.FCSMARAList}")
@SuppressWarnings({"rawtypes","unchecked","unused"})
public abstract class FCSMARAList_GENERATED
    extends PageBean
    implements Serializable, IDestroyable
{
    ...
    protected class MyBeanDataGridWithEditorListener
        extends DefaultBeanListWithEditorListener<DOFCSMARA>
    {
        public MyBeanDataGridWithEditorListener() { super(FCSMARAList_GENERATED.this); }
        @Override
    ...
    protected BeanDataGridWithEditor<DOFCSMARA> m_gridWithEditor;

    // ------------------------------------------------------------------------
    // constructors & initialization
    // ------------------------------------------------------------------------

    public FCSMARAList_GENERATED()
    {
        createGridWithEditor();
    }

    @Override
    public String getPageName() { return "/eone/fcs/view/dialogs/FCSMARAList.xml"; }
    @Override
    public String getRootExpressionUsedInPage() { return "#{d.FCSMARAList}"; }
     ...
     * view for the entity:
     * protected BeanDataGridWithEditor<DOFCSMARA> createBeanDataGridWithEditor()
     * {
     *     return new BeanDataGridWithEditor<DOFCSMARA>(DOFCSMARA.class); 
     * }
     */
    ...
    protected BeanDataGridWithEditor<DOFCSMARA> createBeanDataGridWithEditor()
    {
        return new BeanDataGridWithEditor<DOFCSMARA>(DOFCSMARA.class)
        {
            ...
            {
                return new CCDataGridView2DOFWWrapperWithViewMapping<DOFCSMARA,VIFCSMARA>(DOFCSMARA.class,VIFCSMARA.class);
            }
        }; 
    }
