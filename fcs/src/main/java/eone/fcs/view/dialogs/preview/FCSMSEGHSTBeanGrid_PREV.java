...
public class FCSMSEGHSTBeanGrid_PREV implements IPreviewInstanceConfigurator<FCSMSEGHSTBeanGrid>
{
    @Override
    public void configureForPreview(String beanName, FCSMSEGHSTBeanGrid instance)
    {
        DCDataContextDummy dc = new DCDataContextDummy(new Object());
        instance.prepare(ENUMEditMode.EDIT,dc,DOFCSMSEGHST.class,"dummy",null);
    }
}
