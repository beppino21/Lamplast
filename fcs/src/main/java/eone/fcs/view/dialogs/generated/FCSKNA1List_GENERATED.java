...
@CCGenClass (expressionBase="#{d.FCSKNA1List}")
@SuppressWarnings({"rawtypes","unchecked","unused"})
public abstract class FCSKNA1List_GENERATED
    extends PageBean
    implements Serializable, IDestroyable
{
    ...
    protected class MyBeanDataGridWithEditorListener
        extends DefaultBeanListWithEditorListener<DOFCSKNA1>
    {
        public MyBeanDataGridWithEditorListener() { super(FCSKNA1List_GENERATED.this); }
        @Override
    ...
    protected BeanDataGridWithEditor<DOFCSKNA1> m_gridWithEditor;

    // ------------------------------------------------------------------------
    // constructors & initialization
    // ------------------------------------------------------------------------

    public FCSKNA1List_GENERATED()
    {
        createGridWithEditor();
    }

    @Override
    public String getPageName() { return "/eone/fcs/view/dialogs/FCSKNA1List.xml"; }
    @Override
    public String getRootExpressionUsedInPage() { return "#{d.FCSKNA1List}"; }
     ...
     * view for the entity:
     * protected BeanDataGridWithEditor<DOFCSKNA1> createBeanDataGridWithEditor()
     * {
     *     return new BeanDataGridWithEditor<DOFCSKNA1>(DOFCSKNA1.class); 
     * }
     */
    ...
    protected BeanDataGridWithEditor<DOFCSKNA1> createBeanDataGridWithEditor()
    {
        return new BeanDataGridWithEditor<DOFCSKNA1>(DOFCSKNA1.class)
        {
            ...
            {
                return new CCDataGridView2DOFWWrapperWithViewMapping<DOFCSKNA1,VIFCSKNA1>(DOFCSKNA1.class,VIFCSKNA1.class);
            }
        }; 
    }
