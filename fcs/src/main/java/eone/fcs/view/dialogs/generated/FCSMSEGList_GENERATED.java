...
@CCGenClass (expressionBase="#{d.FCSMSEGList}")
@SuppressWarnings({"rawtypes","unchecked","unused"})
public abstract class FCSMSEGList_GENERATED
    extends PageBean
    implements Serializable, IDestroyable
{
    ...
    protected class MyBeanDataGridWithEditorListener
        extends DefaultBeanListWithEditorListener<DOFCSMSEG>
    {
        public MyBeanDataGridWithEditorListener() { super(FCSMSEGList_GENERATED.this); }
        @Override
    ...
    protected BeanDataGridWithEditor<DOFCSMSEG> m_gridWithEditor;

    // ------------------------------------------------------------------------
    // constructors & initialization
    // ------------------------------------------------------------------------

    public FCSMSEGList_GENERATED()
    {
        createGridWithEditor();
    }

    @Override
    public String getPageName() { return "/eone/fcs/view/dialogs/FCSMSEGList.xml"; }
    @Override
    public String getRootExpressionUsedInPage() { return "#{d.FCSMSEGList}"; }
     ...
     * view for the entity:
     * protected BeanDataGridWithEditor<DOFCSMSEG> createBeanDataGridWithEditor()
     * {
     *     return new BeanDataGridWithEditor<DOFCSMSEG>(DOFCSMSEG.class); 
     * }
     */
    ...
    protected BeanDataGridWithEditor<DOFCSMSEG> createBeanDataGridWithEditor()
    {
        return new BeanDataGridWithEditor<DOFCSMSEG>(DOFCSMSEG.class)
        {
            ...
            {
                return new CCDataGridView2DOFWWrapperWithViewMapping<DOFCSMSEG,VIFCSMSEG>(DOFCSMSEG.class,VIFCSMSEG.class);
            }
        }; 
    }
