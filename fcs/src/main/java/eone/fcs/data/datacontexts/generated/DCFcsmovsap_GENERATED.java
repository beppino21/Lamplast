...
public abstract class DCFcsmovsap_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSMOVSAP>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSMOVSAP = new DCKey(DOFCSMOVSAP.class);
    ...
    public DCFcsmovsap_GENERATED(DOFCSMOVSAP homeObject) { super(homeObject); }
    public DCFcsmovsap_GENERATED(String dbContextName, DOFCSMOVSAP homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSMOVSAP; }
