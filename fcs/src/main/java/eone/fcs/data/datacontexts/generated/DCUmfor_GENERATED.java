...
public abstract class DCUmfor_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOUMFOR>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOUMFOR = new DCKey(DOUMFOR.class);
    ...
    public DCUmfor_GENERATED(DOUMFOR homeObject) { super(homeObject); }
    public DCUmfor_GENERATED(String dbContextName, DOUMFOR homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOUMFOR; }
