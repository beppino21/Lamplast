...
public abstract class DCUmcli_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOUMCLI>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOUMCLI = new DCKey(DOUMCLI.class);
    ...
    public DCUmcli_GENERATED(DOUMCLI homeObject) { super(homeObject); }
    public DCUmcli_GENERATED(String dbContextName, DOUMCLI homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOUMCLI; }
