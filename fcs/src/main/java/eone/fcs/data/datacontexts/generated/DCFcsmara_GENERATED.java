...
public abstract class DCFcsmara_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSMARA>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSMARA = new DCKey(DOFCSMARA.class);
    ...
    public DCFcsmara_GENERATED(DOFCSMARA homeObject) { super(homeObject); }
    public DCFcsmara_GENERATED(String dbContextName, DOFCSMARA homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSMARA; }
