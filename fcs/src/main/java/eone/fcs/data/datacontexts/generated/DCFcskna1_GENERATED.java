...
public abstract class DCFcskna1_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSKNA1>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSKNA1 = new DCKey(DOFCSKNA1.class);
    ...
    public DCFcskna1_GENERATED(DOFCSKNA1 homeObject) { super(homeObject); }
    public DCFcskna1_GENERATED(String dbContextName, DOFCSKNA1 homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSKNA1; }
