...
public abstract class DCFcst001_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCST001>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCST001 = new DCKey(DOFCST001.class);
    ...
    public DCFcst001_GENERATED(DOFCST001 homeObject) { super(homeObject); }
    public DCFcst001_GENERATED(String dbContextName, DOFCST001 homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCST001; }
