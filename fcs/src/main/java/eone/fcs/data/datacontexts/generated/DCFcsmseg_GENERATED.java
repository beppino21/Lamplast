...
public abstract class DCFcsmseg_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSMSEG>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSMSEG = new DCKey(DOFCSMSEG.class);
    ...
    public DCFcsmseg_GENERATED(DOFCSMSEG homeObject) { super(homeObject); }
    public DCFcsmseg_GENERATED(String dbContextName, DOFCSMSEG homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSMSEG; }
