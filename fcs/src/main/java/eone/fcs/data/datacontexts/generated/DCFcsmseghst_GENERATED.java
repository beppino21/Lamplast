...
public abstract class DCFcsmseghst_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSMSEGHST>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSMSEGHST = new DCKey(DOFCSMSEGHST.class);
    ...
    public DCFcsmseghst_GENERATED(DOFCSMSEGHST homeObject) { super(homeObject); }
    public DCFcsmseghst_GENERATED(String dbContextName, DOFCSMSEGHST homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSMSEGHST; }
