...
public abstract class DCFcsekethst_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSEKETHST>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSEKETHST = new DCKey(DOFCSEKETHST.class);
    ...
    public DCFcsekethst_GENERATED(DOFCSEKETHST homeObject) { super(homeObject); }
    public DCFcsekethst_GENERATED(String dbContextName, DOFCSEKETHST homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSEKETHST; }
