...
public abstract class DCFcseket_GENERATED
    extends org.eclnt.dataapp.logic.entities.datacontext.DCDataContext<DOFCSEKET>
    implements Serializable, ICCEEConstants
{
    ...
    public static final DCKey DCKEY_DOFCSEKET = new DCKey(DOFCSEKET.class);
    ...
    public DCFcseket_GENERATED(DOFCSEKET homeObject) { super(homeObject); }
    public DCFcseket_GENERATED(String dbContextName, DOFCSEKET homeObject) { super(dbContextName,homeObject); }

    // ------------------------------------------------------------------------
    // public access
    // ------------------------------------------------------------------------
    
    protected DCKey getHomeObjectContentType() { return DCKEY_DOFCSEKET; }
