...
@XmlRootElement
@doentity(table="TABFCSMSEG",tenantColumn="tenant")
@doclassmapping(metaDataId="fcs",entityId="FCSMSEG",dataContextClassName="eone.fcs.data.datacontexts.DCFcsmseg",controllerClassName="eone.fcs.logic.controllers.FCSMSEGController",detailUIClassName="eone.fcs.view.dialogs.FCSMSEGDetail",listControllerClassName="eone.fcs.logic.controllers.FCSMSEGListController",beanGridUIClassName="eone.fcs.view.dialogs.FCSMSEGBeanGrid")

public class DOFCSMSEG
    implements Serializable
{
    ...
    @dovalidationinfo(mandatory=true)
