...
@XmlRootElement
@doentity(table="TABFCSKNA1",tenantColumn="tenant")
@doclassmapping(metaDataId="fcs",entityId="FCSKNA1",dataContextClassName="eone.fcs.data.datacontexts.DCFcskna1",controllerClassName="eone.fcs.logic.controllers.FCSKNA1Controller",detailUIClassName="eone.fcs.view.dialogs.FCSKNA1Detail",listControllerClassName="eone.fcs.logic.controllers.FCSKNA1ListController",beanGridUIClassName="eone.fcs.view.dialogs.FCSKNA1BeanGrid")

public class DOFCSKNA1
