...
@XmlRootElement
@doentity(table="TABFCSEKETHST",tenantColumn="tenant")
@doclassmapping(metaDataId="fcs",entityId="FCSEKETHST",dataContextClassName="eone.fcs.data.datacontexts.DCFcsekethst",controllerClassName="eone.fcs.logic.controllers.FCSEKETHSTController",detailUIClassName="eone.fcs.view.dialogs.FCSEKETHSTDetail",listControllerClassName="eone.fcs.logic.controllers.FCSEKETHSTListController",beanGridUIClassName="eone.fcs.view.dialogs.FCSEKETHSTBeanGrid")

public class DOFCSEKETHST
    implements Serializable
{
    ...
    @doproperty(sequence=37,uuid2string=true)
