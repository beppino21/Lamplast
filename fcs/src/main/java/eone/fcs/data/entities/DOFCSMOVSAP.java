    ...
    implements Serializable
{
    ...
    UUID m_movid = UUID.randomUUID();
    @doproperty(key=true,sequence=1,uuid2string=true)
    @dovalidationinfo(charMaxLength=36)
    @XmlAttribute()
    public UUID getMovid() { return m_movid; }
    public void setMovid(UUID value) { m_movid = value; }
